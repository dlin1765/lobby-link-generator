        ...
        <>
            ...
            <div className="infoSectionParent">
                    ...
                    <div className="infoExplanation S">
                        Press ctrl C while in any game and Lobby Linker copies a <strong style={{letterSpacing: '0.5px', color:'white'}}>clickable</strong> Steam lobby link to your clipboard!
                    </div>
                    <div className="infoExplanation S">
            ...
            <div className="infoSectionParent2">
                    ...
                    <div className="cards">
                        ...
                        <div className="infoCard">
                            <div className="infoImg"></div>
                            <div className="infoTitle">lobbylinker.com</div>
